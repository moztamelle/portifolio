...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Olá, Eu sou Francisco</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          Criando aplicações que unem <span className="heroShiny1 text-fun-pink">design</span> ,{" "}
          <span className="heroShiny2 text-fun-pink">performance</span>,{" "}<span className="heroShiny2 text-fun-pink">inovação</span> Web, Mobile e Desktop.
          <img
